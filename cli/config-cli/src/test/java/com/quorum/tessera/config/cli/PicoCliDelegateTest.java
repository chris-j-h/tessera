...
public class PicoCliDelegateTest {
  ...
  //    assertThat(sysout)
  //        .contains("Usage: tessera [OPTIONS] [COMMAND]", "Description:", "Options:",
  // "Commands:");
  //  }
  //
  //  @Test
  ...
  //    assertThat(sysout)
  //        .contains(
  //            "Usage: tessera keygen [OPTIONS] [COMMAND]", "Description:", "Options:",
  // "Commands:");
  //  }
  //
  //  @Test
  ...
  //
  //    assertThat(ex).isExactlyInstanceOf(CliException.class);
  //    assertThat(ex).hasMessage("Missing required parameter for option '--config-file'
  // (<config>)");
  //  }
  //
  //  @Test
  ...
  //
  //    CliResult result = cliDelegate.execute("-keygen", "-filename",
  ...
  //    CliResult result =
  //        cliDelegate.execute(
  //            "-keygen", "-filename", keyOutputPath.toString(), "-configfile",
  // configFile.toString());
  //
  //    assertThat(result).isNotNull();
  //    assertThat(result.getStatus()).isEqualTo(0);
  ...
  //    assertThat(ex)
  //        .hasMessage(
  //            "Value for option option '--override' (<String=String>) should be in KEY=VALUE
  // format but was jdbc.autoCreateTables");
  //  }
  //
  //  @Test
  ...
  //        catchThrowable(
  //            () ->
  //                cliDelegate.execute("-configfile", configFile.toString(), "-bogus",
  // "bogusvalue"));
  //
  //    assertThat(ex).isExactlyInstanceOf(CliException.class);
  //    assertThat(ex)
  ...
  //
  //    final Path configOutputPath = configFile.resolveSibling(UUID.randomUUID().toString() +
  // ".json");
  //
